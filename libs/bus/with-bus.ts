...
import { Bus, DEFAULT_URL } from './bus.ts'
 ...
 * running?" hint so operators know where to look. Every CLI command (and
 * module CLI subcommand) that needs the bus goes through here so lifecycle
