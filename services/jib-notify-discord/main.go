// Command jib-notify-discord sends event notifications via Discord.
package main
...
func main() {
	channelName := notifysvc.EnvOr("CHANNEL_NAME", "discord")
	...
	notifysvc.Run(channelName, notify.NewDiscord(creds.WebhookURL))
}
