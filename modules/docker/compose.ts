...
export class Compose {
  ...
  constructor(readonly cfg: ComposeConfig) {
    this.compose = dockerCreateCompose(cfg)
  }

  projectName(): string {
    return this.compose.projectName()
  }

  /** `compose -p jib-<app> -f file1 -f file2 [-f override]` shared prefix. */
  baseArgs(): string[] {
    return this.compose.baseArgs()
  }
