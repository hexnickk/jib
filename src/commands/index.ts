/**
 * Barrel of every citty command definition under `src/commands/`.
 * `apps/jib/main.ts` imports this and mounts them on the root command.
 * Each export is a `CommandDef`; per-domain subcommand trees are
 * assembled inside their own file.
 */
...
export { default as sourcesCmd } from './sources.ts'
export { default as watchCmd } from './watch.ts'
