...
test('removeApp > best-effort steps warn and config removal still lands', async () => {
...
test('removeApp > best-effort steps also downgrade thrown custom-support failures', async () => {
  const warnings: string[] = []
...
test('removeApp > returns a typed error when the app does not exist', async () => {
  const support: RemoveSupport = {
...
test('removeApp > returns a typed config write error from the primary API', async () => {
  const support: RemoveSupport = {
    releaseIngress: async () => undefined,
    stopApp: async () => undefined,
    removeCheckout: async () => undefined,
...
test('removeApp > returns a typed config write error without throwing', async () => {
  const support: RemoveSupport = {
    releaseIngress: async () => undefined,
    stopApp: async () => undefined,
    removeCheckout: async () => undefined,
